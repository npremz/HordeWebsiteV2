...
Sur votre propre site, partez d’une page et d’une tâche précise. Regardez ce qu’une personne peut reconnaître, comprendre et faire. Le tableau suivant donne des exemples de problèmes à chercher et de décisions à discuter.
...
Regarder [ce qu’on peut retenir d’un autre site sans le copier](/fr/blog/analyser-interface-web-sans-copier/) aide à préciser les choix qui vous intéressent. Et le [brief d’expérience avant les maquettes](/fr/blog/brief-design-web-cadrer-experience/) relie ces choix aux usages, aux valeurs et aux contraintes de votre organisation.
