...
| Site produit rapidement | Site pensé pour durer |
| --- | --- |
| Commence par un modèle | Commence par un positionnement |
| Personnalise les couleurs et le logo | Construit un langage visuel cohérent |
| Reprend des textes génériques | Répond aux questions d’un public précis |
| Optimise la première démonstration | Prévoit la mesure, le contenu et l’évolution |
| Dépend surtout du trafic acheté | Diversifie recherche, accès direct et recommandation |
