export const fr = {
  ...
  hero: {
    ...
    typewriterWords: ['ultra rapides', 'optimisees', 'user friendly', 'soignees'],
    agency: 'Agence Digitale',
    location: 'UX à Bruxelles',
  ...
  method: {
    ...
    methods: [
      ...
      },
      {
        ...
        quote:
          "On s'occupe de la complexité technique pour que vous restiez concentré sur votre vision.",
        description:
  ...
  services: {
    ...
    servicesList: 'Liste de services',
    startProject: 'Démarrer un projet',
    items: [
      {
      ...
      },
      {
        ...
        content:
          'Lancement de produit ou nouvelle identité ? Nous concevons des plateformes sur-mesure. Une architecture solide et pensée pour vos finances à long terme.',
      },
    ],
  },
  ...
  blogPage: {
    ...
    categoryPageHeading: "Articles, méthodes et retours d'expérience sur {category}",
    listingTitleSuffix: 'Blog Horde',
    tagPageTitle: 'Articles sur {tag} | Horde',
    tagPageDescription:
      "Retrouvez nos articles sur {tag} : conseils, analyses et retours d'expérience autour du web, du design et de la performance.",
    tagPageHeading: "Articles, méthodes et retours d'expérience autour de {tag}",
  ...
  footer: {
    ...
    sayHello: 'Dites-nous bonjour :)',
    menu: 'Menu',
    contactAriaLabel: "Contacter Let's Talk",
  },
  ...
  form: {
    ...
    objectifPlaceholder: 'Ce que vous avez en tête...',
    nameLabel: 'Nom',
    namePlaceholder: "Un autographe, s'il vous plaît",
    emailLabel: 'Email',
